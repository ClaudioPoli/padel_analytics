...
# Input video path (supporta diversi formati video)
# Formati supportati: .mp4, .mov, .avi, .mkv, .wmv, ecc.
INPUT_VIDEO_PATH = "/Users/claudio/Documents/GitHub/PadelStats/data/input/test.mov"

# Inference video path (l'estensione del file determinerà il formato dell'output)
# Imposta l'estensione desiderata: .mp4, .mov, .avi, .mkv, .wmv, ecc.
# Esempio: "results.mp4" o "results.mov"
...
FIXED_COURT_KEYPOINTS_SAVE_PATH = None # "/Users/claudio/Documents/GitHub/PadelStats/src/.cache/fixed_keypoints_detection.json"
